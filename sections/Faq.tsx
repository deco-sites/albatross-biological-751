...
export default function BlogPosts({ title = "FAQs", description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.", cta = { href: "/", text: "Change me", outline: true }, questions = [{
